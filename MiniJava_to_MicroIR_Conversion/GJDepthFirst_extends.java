...
public class GJDepthFirst<R,A> implements GJVisitor<R,A> {
   ...
   HashMap<String,String> parent_class = new HashMap<String,String>();
   ...
   public R visit(ClassExtendsDeclaration n, A argu) {
      ...
      if(extend_traverse)
      {
         ...
         parent_class.put(class_name,parent_name);

         HashMap<String,String> temp5 = new HashMap<String,String>();
         class_var_type.put(class_name,temp5);

         HashMap<String,String> temp6 = new HashMap<String,String>();
         class_var_type.put(parent_name,temp6);
      }
      ...
      if(Storage)
      {
         ...
         n.f5.accept(this, (A)loc);
         n.f6.accept(this, (A)loc);
         n.f7.accept(this, argu);

         if(extend)
         {
            System.out.println("class declaration done in extends");
         }
   ...
   public R visit(VarDeclaration n, A argu) {
      ...
      if(Storage)
      {
         ...
         if(loc.get(1) == "class")
         {
            ...
            // if(extend)
            // {
            //    System.out.println("var declration parent");
            //    System.out.println(parent_class);
            // }
            Collection<String> parents = parent_class.values();
            if(parents.contains(class_name))
            {
               for (Map.Entry<String, String> entry : parent_class.entrySet())
               {
                  if(entry.getValue() == class_name)
                  {
                     String child_class_name = entry.getKey();
                     // if(extend)
                     // {
                     //    System.out.println("child naem is : " + child_class_name + " and parent name is : "+class_name);
                     //    System.out.println("common variable is : "+var_name+" and the type is : "+type+" \n\n");
                     // }
                     class_var_type.get(child_class_name).put(var_name,type);
                  }
               }
            }
   ...
   public R visit(IfthenStatement n, A argu) {
      ...
      else
      {
         ...
         n.f0.accept(this, argu);
         n.f1.accept(this, argu);
         int if_label = labels; labels++;
         n.f2.accept(this, argu);
         int env_index = temp_start_value.get(loc.get(0)).get(loc.get(1));
         System.out.println("CJUMP TEMP " + (env_index-1) + " L" + if_label);
         n.f3.accept(this, argu);
         n.f4.accept(this, argu);
         System.out.println("L" + if_label);
         System.out.println("NOOP");
      }
      return _ret;
   }
   ...
   public R visit(IfthenElseStatement n, A argu) {
      ...
      else
      {
         ...
         int else_label = labels; labels++;
         int final_label = labels; labels++;

         n.f2.accept(this, argu);
         int env_index = temp_start_value.get(loc.get(0)).get(loc.get(1));
         System.out.println("CJUMP TEMP " + (env_index-1) + " L" + else_label);

         n.f3.accept(this, argu);
         n.f4.accept(this, argu);

         System.out.println("JUMP L" + final_label);
         ...
         System.out.println("L" + final_label);
         System.out.println("NOOP");
      }
      return _ret;
   }
   ...
   public R visit(WhileStatement n, A argu) {
      ...
      else
      {
         ...
         int start_label = labels; labels++;
         int jump_label = labels; labels++;
   ...
   public R visit(DoStatement n, A argu) {
      ...
      else
      {
         ...
         System.out.println("L" + start_label);
         System.out.println("NOOP");
   ...
   public R visit(MessageSend n, A argu) {
      ...
      else
      {
         ...
         if(extend)
         {
            System.out.println("cjecking type of index : "+(env_index-1));
         }
         ...
         {
            System.out.println("//class name is "+object_type+" method name is "+method_name);
         }
      ...
      else
      {
         ...
         if(n.f0.which == 3)
         {
            ...
            if(class_var.get(loc.get(0)).containsKey(id))
            {
               ...
               if(extend)
               {
                  System.out.println("class name is "+loc.get(0));
                  System.out.println(class_var_type.get(loc.get(0)));
               }
   ...
   public R visit(AllocationExpression n, A argu) {
      ...
      else
      {
         ...
         if(parent_class.containsKey(class_name))
         {
            String parent_class_name = parent_class.get(class_name);
            Integer env_index = temp_start_value.get(loc.get(0)).get(loc.get(1));

            Collection<String>var_parent = class_var.get(parent_class_name).keySet();
            Collection<String>var_child = class_var.get(class_name).keySet();
            Vector<String>remain_var = new Vector<String>();
            for(String item : var_parent)
            {
               if(!var_child.contains(item))
               {
                  remain_var.add(item);
               }
            }

            Collection<String>method_parent = method_names.get(parent_class_name).keySet();
            Collection<String>method_child = method_names.get(class_name).keySet();
            Vector<String>remain_method = new Vector<String>();
            for(String item : method_parent)
            {
               if(!method_child.contains(item))
               {
                  remain_method.add(item);
               }
            }

            int var_size = remain_var.size()+class_var.get(class_name).size();
            System.out.println("MOVE TEMP "+env_index+" "+(var_size+1)*4);
            System.out.println("MOVE TEMP "+(env_index+1)+" HALLOCATE TEMP "+env_index);
            int struct_address = env_index+1;
            env_index=env_index+2;

            int method_Size = remain_method.size()+method_names.get(class_name).size();
            System.out.println("MOVE TEMP "+env_index+" "+method_Size*4);
            System.out.println("MOVE TEMP "+(env_index+1)+" HALLOCATE TEMP "+env_index);
            int method_table_address = env_index+1;
            env_index=env_index+2;
            //functions check overiding
            //assign indexes to the methods
            ...
            if(remain_method.size()>0)
            {
               Collection<Integer>offsets = method_names.get(class_name).values();
               int max_Value=-1;
               if(offsets.size()==0) {max_Value=0;}
               else {max_Value = Collections.max(offsets);}
               for(int i=0;i<remain_method.size();i++)
               {
                  String method_name = remain_method.get(i);
                  String offset = Integer.toString(max_Value+(i+1)*4);
                  method_names.get(class_name).put(method_name,max_Value+(i+1)*4);
                  String storing = class_name+"_"+method_name;
                  System.out.println("MOVE TEMP "+env_index+" "+storing);
                  System.out.println("HSTORE TEMP "+method_table_address+" "+offset+" TEMP "+env_index);
                  env_index++;
            ...
            //var declaration in parent class
            if(remain_var.size() > 0)
            {
               Collection<Integer>offsets = class_var.get(class_name).values();
               int max_Value = -1;
               if(offsets.size()==0) {max_Value=0;}
               else{max_Value = Collections.max(offsets);}
               for(int i=0;i<remain_var.size();i++)
               {
                  String var_name = remain_var.get(i);
                  String offset = Integer.toString(max_Value+(i+1)*4);
                  class_var.get(class_name).put(var_name,max_Value+(i+1)*4);
                  System.out.println("MOVE TEMP "+env_index+" 0");
                  System.out.println("HSTORE TEMP "+struct_address+" "+ offset+" TEMP "+env_index);
                  env_index++;
               }
